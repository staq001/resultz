...
export function StudentSettingsPage({
  ...
  backButtonLabel = "Back to Student Home",
  userName,
  userEmail,
  matricNo,
  avatarUrl,
    ...
    <main className="dashboard-wrap">
      ...
      <section className="panel settings-inline-panel">
        ...
        <div className="settings-inline-row">
          <div className="settings-inline-meta">
            <strong>Email</strong>
            <p className="sub">Email address for account updates.</p>
          </div>
          <div className="settings-inline-control">
            <div className="settings-inline-view-stack">
        ...
        <div className="settings-inline-row">
          <div className="settings-inline-meta">
            ...
            <p className="sub">Your student identification number.</p>
          </div>
          <div className="settings-inline-control">
            <div className="settings-inline-view-stack">
              <input value={matricNo || "N/A"} readOnly />
            </div>
          </div>
        </div>
